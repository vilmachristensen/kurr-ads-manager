...
var $5e63c961fc1ce211$export$8c6ed5c666ac1360 = (0, import_react.forwardRef)((props, forwardedRef) => {
  let { children, ...slotProps } = props, childrenArray = import_react.Children.toArray(children), slottable = childrenArray.find($5e63c961fc1ce211$var$isSlottable);
  if (slottable) {
    let newElement = slottable.props.children, newChildren = childrenArray.map((child) => child === slottable ? import_react.Children.count(newElement) > 1 ? import_react.Children.only(null) : (0, import_react.isValidElement)(newElement) ? newElement.props.children : null : child);
    return (0, import_react.createElement)($5e63c961fc1ce211$var$SlotClone, _extends4({}, slotProps, { ref: forwardedRef }), (0, import_react.isValidElement)(newElement) ? (0, import_react.cloneElement)(newElement, void 0, newChildren) : null);
  }
  return (0, import_react.createElement)($5e63c961fc1ce211$var$SlotClone, _extends4({}, slotProps, { ref: forwardedRef }), children);
});
...
var $5e63c961fc1ce211$export$d9f1ccf0bdb05d45 = ({ children }) => (0, import_react.createElement)(import_react.Fragment, null, children);
...
var $8927f6f2acc4f386$export$250ffa63cdc0d034 = $8927f6f2acc4f386$var$NODES.reduce((primitive, node) => {
  let Node = (0, import_react.forwardRef)((props, forwardedRef) => {
    ...
    }, []), (0, import_react.createElement)(Comp, _extends3({}, primitiveProps, { ref: forwardedRef }));
  });
  return Node.displayName = `Primitive.${node}`, { ...primitive, [node]: Node };
}, {});
var $9f79659886946c16$export$e5c5a5f917a5871c = (globalThis == null ? void 0 : globalThis.document) ? import_react.useLayoutEffect : () => {
};
...
var $921a889cee6df7e8$export$99c2b779aa4e8b8b = (props) => {
  let { present, children } = props, presence = $921a889cee6df7e8$var$usePresence(present), child = typeof children == "function" ? children({ present: presence.isPresent }) : import_react.Children.only(children), ref = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(presence.ref, child.ref);
  return typeof children == "function" || presence.isPresent ? (0, import_react.cloneElement)(child, { ref }) : null;
};
$921a889cee6df7e8$export$99c2b779aa4e8b8b.displayName = "Presence";
function $921a889cee6df7e8$var$usePresence(present) {
  let [node1, setNode] = (0, import_react.useState)(), stylesRef = (0, import_react.useRef)({}), prevPresentRef = (0, import_react.useRef)(present), prevAnimationNameRef = (0, import_react.useRef)("none"), initialState = present ? "mounted" : "unmounted", [state, send] = $fe963b355347cc68$export$3e6543de14f8614f(initialState, { mounted: { UNMOUNT: "unmounted", ANIMATION_OUT: "unmountSuspended" }, unmountSuspended: { MOUNT: "mounted", ANIMATION_END: "unmounted" }, unmounted: { MOUNT: "mounted" } });
  return (0, import_react.useEffect)(() => {
    ...
    if (node1) {
      let handleAnimationEnd = (event) => {
        ...
        event.target === node1 && isCurrentAnimation && (0, import_react_dom.flushSync)(() => send("ANIMATION_END"));
      ...
      send("ANIMATION_END");
  }, [node1, send]), { isPresent: ["mounted", "unmountSuspended"].includes(state), ref: (0, import_react.useCallback)((node) => {
...
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
  ...
  function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
    let BaseContext = (0, import_react.createContext)(defaultContext), index = defaultContexts.length;
    defaultContexts = [...defaultContexts, defaultContext];
    function Provider(props) {
      let { scope, children, ...context } = props, Context = (scope == null ? void 0 : scope[scopeName][index]) || BaseContext, value = (0, import_react.useMemo)(() => context, Object.values(context));
      return (0, import_react.createElement)(Context.Provider, { value }, children);
    }
    function useContext$1(consumerName, scope) {
      let Context = (scope == null ? void 0 : scope[scopeName][index]) || BaseContext, context = (0, import_react.useContext)(Context);
      if (context)
        return context;
  ...
  let createScope = () => {
    let scopeContexts = defaultContexts.map((defaultContext) => (0, import_react.createContext)(defaultContext));
    return function(scope) {
      let contexts = (scope == null ? void 0 : scope[scopeName]) || scopeContexts;
      return (0, import_react.useMemo)(() => ({ [`__scope${scopeName}`]: { ...scope, [scopeName]: contexts } }), [scope, contexts]);
    };
  };
...
function $c512c27ab02ef895$var$composeContextScopes(...scopes) {
  ...
  let createScope1 = () => {
    ...
    return function(overrideScopes) {
      ...
      return (0, import_react.useMemo)(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes1 }), [nextScopes1]);
    };
  };
...
function $f631663db3294ace$export$b39126d51d94e6f3(localDir) {
  let globalDir = (0, import_react.useContext)($f631663db3294ace$var$DirectionContext);
...
var $57acba87d6e25586$export$ccf8d8d7bbf3c2cc = (0, import_react.forwardRef)((props, forwardedRef) => {
  let { __scopeScrollArea, type = "hover", dir, scrollHideDelay = 600, ...scrollAreaProps } = props, [scrollArea, setScrollArea] = (0, import_react.useState)(null), [viewport, setViewport] = (0, import_react.useState)(null), [content, setContent] = (0, import_react.useState)(null), [scrollbarX, setScrollbarX] = (0, import_react.useState)(null), [scrollbarY, setScrollbarY] = (0, import_react.useState)(null), [cornerWidth, setCornerWidth] = (0, import_react.useState)(0), [cornerHeight, setCornerHeight] = (0, import_react.useState)(0), [scrollbarXEnabled, setScrollbarXEnabled] = (0, import_react.useState)(false), [scrollbarYEnabled, setScrollbarYEnabled] = (0, import_react.useState)(false), composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, (node) => setScrollArea(node)), direction = $f631663db3294ace$export$b39126d51d94e6f3(dir);
  return (0, import_react.createElement)($57acba87d6e25586$var$ScrollAreaProvider, { scope: __scopeScrollArea, type, dir: direction, scrollHideDelay, scrollArea, viewport, onViewportChange: setViewport, content, onContentChange: setContent, scrollbarX, onScrollbarXChange: setScrollbarX, scrollbarXEnabled, onScrollbarXEnabledChange: setScrollbarXEnabled, scrollbarY, onScrollbarYChange: setScrollbarY, scrollbarYEnabled, onScrollbarYEnabledChange: setScrollbarYEnabled, onCornerWidthChange: setCornerWidth, onCornerHeightChange: setCornerHeight }, (0, import_react.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends2({ dir: direction }, scrollAreaProps, { ref: composedRefs, style: { position: "relative", "--radix-scroll-area-corner-width": cornerWidth + "px", "--radix-scroll-area-corner-height": cornerHeight + "px", ...props.style } })));
});
...
var $57acba87d6e25586$export$a21cbf9f11fca853 = (0, import_react.forwardRef)((props, forwardedRef) => {
  let { __scopeScrollArea, children, ...viewportProps } = props, context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$VIEWPORT_NAME, __scopeScrollArea), ref = (0, import_react.useRef)(null), composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, ref, context.onViewportChange);
  return (0, import_react.createElement)(import_react.Fragment, null, (0, import_react.createElement)("style", { dangerouslySetInnerHTML: { __html: "[data-radix-scroll-area-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-radix-scroll-area-viewport]::-webkit-scrollbar{display:none}" } }), (0, import_react.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends2({ "data-radix-scroll-area-viewport": "" }, viewportProps, { ref: composedRefs, style: { overflowX: context.scrollbarXEnabled ? "scroll" : "hidden", overflowY: context.scrollbarYEnabled ? "scroll" : "hidden", ...props.style } }), (0, import_react.createElement)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" } }, children)));
});
...
var $57acba87d6e25586$var$ScrollAreaScrollbarHover = (0, import_react.forwardRef)((props, forwardedRef) => {
  ...
  }, [context.scrollArea, context.scrollHideDelay]), (0, import_react.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, { present: forceMount || visible }, (0, import_react.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarAuto, _extends2({ "data-state": visible ? "visible" : "hidden" }, scrollbarProps, { ref: forwardedRef })));
});
var $57acba87d6e25586$var$ScrollAreaScrollbarScroll = (0, import_react.forwardRef)((props, forwardedRef) => {
  ...
  }, [state, context.scrollHideDelay, send]), (0, import_react.useEffect)(() => {
  ...
  }, [context.viewport, isHorizontal, send, debounceScrollEnd]), (0, import_react.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, { present: forceMount || state !== "hidden" }, (0, import_react.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarVisible, _extends2({ "data-state": state === "hidden" ? "hidden" : "visible" }, scrollbarProps, { ref: forwardedRef, onPointerEnter: $e42e1063c40fb3ef$export$b9ecd428b558ff10(props.onPointerEnter, () => send("POINTER_ENTER")), onPointerLeave: $e42e1063c40fb3ef$export$b9ecd428b558ff10(props.onPointerLeave, () => send("POINTER_LEAVE")) })));
});
var $57acba87d6e25586$var$ScrollAreaScrollbarAuto = (0, import_react.forwardRef)((props, forwardedRef) => {
  let context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME, props.__scopeScrollArea), { forceMount, ...scrollbarProps } = props, [visible, setVisible] = (0, import_react.useState)(false), isHorizontal = props.orientation === "horizontal", handleResize = $57acba87d6e25586$var$useDebounceCallback(() => {
    if (context.viewport) {
...
var $57acba87d6e25586$var$ScrollAreaScrollbarVisible = (0, import_react.forwardRef)((props, forwardedRef) => {
  ...
  } })) : orientation === "vertical" ? (0, import_react.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarY, _extends2({}, commonProps, { ref: forwardedRef, onThumbPositionChange: () => {
    if (context.viewport && thumbRef.current) {
      let scrollPos = context.viewport.scrollTop, offset = $57acba87d6e25586$var$getThumbOffsetFromScroll(scrollPos, sizes);
...
var $57acba87d6e25586$export$9fba1154677d7cd2 = (0, import_react.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, { present: forceMount || scrollbarContext.hasThumb }, (0, import_react.createElement)($57acba87d6e25586$var$ScrollAreaThumbImpl, _extends2({ ref: forwardedRef }, thumbProps)));
});
    ...
    if (viewport) {
      let handleScroll = () => {
        if (debounceScrollEnd(), !removeUnlinkedScrollListenerRef.current) {
          let listener = $57acba87d6e25586$var$addUnlinkedScrollListener(viewport, onThumbPositionChange);
...
var $57acba87d6e25586$export$56969d565df7cc4b = (0, import_react.forwardRef)((props, forwardedRef) => {
  ...
  return context.type !== "scroll" && hasBothScrollbarsVisible ? (0, import_react.createElement)($57acba87d6e25586$var$ScrollAreaCornerImpl, _extends2({}, props, { ref: forwardedRef })) : null;
});
var $57acba87d6e25586$var$ScrollAreaCornerImpl = (0, import_react.forwardRef)((props, forwardedRef) => {
  let { __scopeScrollArea, ...cornerProps } = props, context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$CORNER_NAME, __scopeScrollArea), [width1, setWidth] = (0, import_react.useState)(0), [height1, setHeight] = (0, import_react.useState)(0), hasSize = !!(width1 && height1);
  ...
  }), hasSize ? (0, import_react.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends2({}, cornerProps, { ref: forwardedRef, style: { width: width1, height: height1, position: "absolute", right: context.dir === "ltr" ? 0 : void 0, left: context.dir === "rtl" ? 0 : void 0, bottom: 0, ...props.style } })) : null;
});
...
function $57acba87d6e25586$var$getThumbSize(sizes) {
  let ratio = $57acba87d6e25586$var$getThumbRatio(sizes.viewport, sizes.content), scrollbarPadding = sizes.scrollbar.paddingStart + sizes.scrollbar.paddingEnd, thumbSize = (sizes.scrollbar.size - scrollbarPadding) * ratio;
...
function $57acba87d6e25586$var$getThumbOffsetFromScroll(scrollPos, sizes, dir = "ltr") {
  let thumbSizePx = $57acba87d6e25586$var$getThumbSize(sizes), scrollbarPadding = sizes.scrollbar.paddingStart + sizes.scrollbar.paddingEnd, scrollbar = sizes.scrollbar.size - scrollbarPadding, maxScrollPos = sizes.content - sizes.viewport, maxThumbPos = scrollbar - thumbSizePx, scrollClampRange = dir === "ltr" ? [0, maxScrollPos] : [maxScrollPos * -1, 0], scrollWithoutMomentum = $ae6933e535247d3d$export$7d15b64cf5a3a4c4(scrollPos, scrollClampRange);
...
function $57acba87d6e25586$var$useDebounceCallback(callback, delay) {
  let handleCallback = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(callback), debounceTimerRef = (0, import_react.useRef)(0);
  return (0, import_react.useEffect)(() => () => window.clearTimeout(debounceTimerRef.current), []), (0, import_react.useCallback)(() => {
...
var ScrollAreaRoot = newStyled($57acba87d6e25586$export$be92b6f5f03c0fe9)(({ scrollbarsize, offset }) => ({ width: "100%", height: "100%", overflow: "hidden", "--scrollbar-size": `${scrollbarsize + offset}px`, "--radix-scroll-area-thumb-width": `${scrollbarsize}px` }));
var ScrollAreaViewport = newStyled($57acba87d6e25586$export$d5c6c08dc2d3ca7)({ width: "100%", height: "100%" });
var ScrollAreaScrollbar = newStyled($57acba87d6e25586$export$9a4e88b92edfce6b)(({ offset, horizontal, vertical }) => ({ display: "flex", userSelect: "none", touchAction: "none", background: "transparent", transition: "all 0.2s ease-out", borderRadius: "var(--scrollbar-size)", '&[data-orientation="vertical"]': { width: "var(--scrollbar-size)", paddingRight: offset, marginTop: offset, marginBottom: horizontal === "true" && vertical === "true" ? 0 : offset }, '&[data-orientation="horizontal"]': { flexDirection: "column", height: "var(--scrollbar-size)", paddingBottom: offset, marginLeft: offset, marginRight: horizontal === "true" && vertical === "true" ? 0 : offset } }));
var ScrollAreaThumb = newStyled($57acba87d6e25586$export$6521433ed15a34db)(({ theme }) => ({ flex: 1, background: theme.textMutedColor, opacity: 0.5, borderRadius: "var(--scrollbar-size)", position: "relative", transition: "opacity 0.2s ease-out", "&:hover": { opacity: 0.8 }, "::before": { content: '""', position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: "100%", height: "100%", minWidth: 44, minHeight: 44 } }));
var ScrollArea = ({ children, horizontal = false, vertical = false, offset = 2, scrollbarSize = 6, className }) => import_react.default.createElement(ScrollAreaRoot, { scrollbarsize: scrollbarSize, offset, className }, import_react.default.createElement(ScrollAreaViewport, null, children), horizontal && import_react.default.createElement(ScrollAreaScrollbar, { orientation: "horizontal", offset, horizontal: horizontal.toString(), vertical: vertical.toString() }, import_react.default.createElement(ScrollAreaThumb, null)), vertical && import_react.default.createElement(ScrollAreaScrollbar, { orientation: "vertical", offset, horizontal: horizontal.toString(), vertical: vertical.toString() }, import_react.default.createElement(ScrollAreaThumb, null)), horizontal && vertical && import_react.default.createElement($57acba87d6e25586$export$ac61190d9fc311a9, null));
...
var Scroller = newStyled(UnstyledScroller)({ position: "relative" }, ({ theme }) => themedSyntax(theme));
...
//# sourceMappingURL=chunk-SCFIZIGL.js.map
