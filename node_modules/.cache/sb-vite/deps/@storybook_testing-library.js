...
} from "./chunk-7HXHPT6C.js";
import {
  require_react_is
} from "./chunk-MH4TDKNE.js";
import {
  esm_default
    ...
    function format2(val, options) {
      if (options) {
        ...
        if (options.plugins) {
          ...
          if (plugin !== null) {
            return printPlugin(plugin, val, getConfig6(options), "", 0, []);
          }
        }
      }
      const basicResult = printBasicValue(
      ...
      return printComplexValue(val, getConfig6(options), "", 0, []);
    }
    var plugins2 = {
...
var once = (type3) => (message, ...rest) => {
  if (!logged.has(message))
    return logged.add(message), logger[type3](message, ...rest);
};
...
var pretty = (type3) => (...args) => {
  ...
  logger[type3].apply(logger, argArray);
};
