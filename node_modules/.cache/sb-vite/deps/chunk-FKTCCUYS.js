...
var background = { app: "#F6F9FC", bar: color.lightest, content: color.lightest, preview: color.lightest, gridCellSize: 10, hoverable: curriedTransparentize$1(0.9, color.secondary), positive: "#E1FFD4", negative: "#FEDED2", warning: "#FFF5CF", critical: "#FF4400" };
...
function _extends22() {
  return _extends22 = Object.assign ? Object.assign.bind() : function(target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
      for (var key in source)
        Object.prototype.hasOwnProperty.call(source, key) && (target[key] = source[key]);
...
var EmotionCacheContext = React.createContext(typeof HTMLElement < "u" ? createCache({ key: "css" }) : null);
...
var Global = withEmotionCache(function(props, cache) {
  ...
  var styles = props.styles, serialized = serializeStyles([styles], void 0, React.useContext(ThemeContext));
...
var ClassNames = withEmotionCache(function(props, cache) {
  ...
  }, content = { css: css2, cx, theme: React.useContext(ThemeContext) }, ele = props.children(content);
  return hasRendered = true, React.createElement(React.Fragment, null, React.createElement(Insertion3, { cache, serializedArr }), ele);
});
...
You may have forgotten to import it.`);
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, cache, ref) {
      ...
      return newProps.className = className, newProps.ref = ref, React.createElement(React.Fragment, null, React.createElement(Insertion5, { cache, serialized, isStringTag: typeof FinalTag == "string" }), React.createElement(FinalTag, newProps));
    });
    return Styled.displayName = identifierName !== void 0 ? identifierName : "Styled(" + (typeof baseTag == "string" ? baseTag : baseTag.displayName || baseTag.name || "Component") + ")", Styled.defaultProps = tag.defaultProps, Styled.__emotion_real = Styled, Styled.__emotion_base = baseTag, Styled.__emotion_styles = styles, Styled.__emotion_forwardProp = shouldForwardProp, Object.defineProperty(Styled, "toString", { value: function() {
      ...
      return createStyled2(nextTag, _extends2({}, options, nextOptions, { shouldForwardProp: composeShouldForwardProps(Styled, nextOptions, true) })).apply(void 0, styles);
    }, Styled;
  };
};
...
//# sourceMappingURL=chunk-FKTCCUYS.js.map
