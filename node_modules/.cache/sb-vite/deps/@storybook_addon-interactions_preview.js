...
var __require22 = ((x) => typeof __require2 < "u" ? __require2 : typeof Proxy < "u" ? new Proxy(x, { get: (a, b) => (typeof __require2 < "u" ? __require2 : a)[b] }) : x)(function(x) {
...
var require_build2 = __commonJS({ "../../node_modules/pretty-format/build/index.js"(exports) {
...
var require_build22 = __commonJS({ "../../node_modules/diff-sequences/build/index.js"(exports) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var toString = Function.prototype.toString, functionNameMatch = /\s*function(?:\s|\s*\/\*[^(?:*\/)]+\*\/\s*)*([^\s\(\/]+)/;
...
var import_pretty_format = __toESM2(require_build2(), 1);
var diff$1 = __toESM2(require_build22(), 1);
...
var import_pretty_format2 = __toESM2(require_build2(), 1);
var import_loupe = __toESM2(require_loupe(), 1);
...
var Instrumenter = class {
  constructor() {
    this.initialized = false, this.channel = import_preview_api.addons.getChannel(), this.state = import_global.global.window.parent.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER_STATE__ || {};
...
var JestMock = new import_jest_mock.ModuleMocker(import_global.global);
...
var instrumentSpies = ({ initialArgs }) => Object.entries(initialArgs).filter(([, value]) => typeof value == "function" && "_isMockFunction" in value && value._isMockFunction && !value._instrumented).reduce((acc, [key, value]) => {
  let instrumented = instrument({ [key]: () => value }, { retain: true })[key];
  return acc[key] = instrumented(), value._instrumented = true, acc;
}, {});
var argsEnhancers = [addActionsFromArgTypes, instrumentSpies];
